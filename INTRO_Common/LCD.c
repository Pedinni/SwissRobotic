...
#endif
#if 1
    {LCD_MENU_ID_ROBOT,                       0,   2,   LCD_MENU_ID_NONE,         LCD_MENU_ID_SUMO_START_STOP,      "Robot",        NULL,                       LCDMENU_MENU_FLAGS_NONE},
      {LCD_MENU_ID_SUMO_START_STOP,           4,   0,   LCD_MENU_ID_ROBOT,        LCD_MENU_ID_NONE,                 NULL,           RobotRemoteMenuHandler,     LCDMENU_MENU_FLAGS_NONE},
      {LCD_MENU_ID_BATTERY_VOLTAGE,           4,   1,   LCD_MENU_ID_ROBOT,        LCD_MENU_ID_NONE,                 NULL,           RobotRemoteMenuHandler,     LCDMENU_MENU_FLAGS_NONE},
      {LCD_MENU_ID_MINT_TOF_SENSOR,           4,   2,   LCD_MENU_ID_ROBOT,        LCD_MENU_ID_NONE,                 NULL,           RobotRemoteMenuHandler,     LCDMENU_MENU_FLAGS_NONE},
#endif
};
